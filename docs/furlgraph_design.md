...
- **The 2026-07-04 slotgraph3 audit** (`docs/slotgraph3_simple_version_audit.md`) named **two walls**:
...
Supersedes the slotgraph line for the binding goal (`docs/slotgraph3_simple_version_audit.md`). Reuses its
