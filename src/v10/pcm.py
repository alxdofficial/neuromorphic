"""Predictive Coding Module for v10-gnn — Dynamic Predictive Coding.
...
Same logic as v9-backprop (src/v8/pcm.py). RMSNorm on surprise is applied
externally (in the LM module), not inside this module.
...
class BatchedPCM(nn.Module):
    ...
    def forward(
        ...
        p1 = F.silu(p1)
        delta_hat_r = (
            torch.bmm(p1, self.pcm_w2) + self.pcm_b2
        )  # [C, BS*T, D_cc]
