...
class GraphV9PyramidEncoder(nn.Module):
    ...
    def __init__(self, cfg: ReprConfig):
        ...
        v9 = GraphV9Config(
            ...
            route_centering=getattr(cfg, "graph_v9_route_centering", False),
            surprise_coact=getattr(cfg, "graph_v9_surprise_coact", False),
            dirs_blend=getattr(cfg, "graph_v9_dirs_blend", "mass"))
