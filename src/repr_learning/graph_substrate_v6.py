...
# (GraphV6FactReader removed — unified-read cleanup. The encoder emits k/v tokens that the
#  shared cross-attention read head consumes; there is no per-encoder inject reader.)
