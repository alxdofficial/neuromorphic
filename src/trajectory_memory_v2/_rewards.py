"""Reward functions for Wave 3 GRPO (ported verbatim from v1).

Per project policy: only exact-match + BERT cosine + rule-based rewards.
No LLM-as-judge.

Public dispatcher: `compute_reward(reward_kind, candidate, gold=..., meta=...)`.
Returns a float in [0, 1] (1 = perfect, 0 = miss).
"""
