...
from scripts.data_build.common.text import (
    with_indef, hour_12h, duration_phrase, count_word,
)
from scripts.data_build.generate.calendar.state import (
    CalendarScenario, CalendarEvent, DAYS, build_scenario, config_space_size,
)
from scripts.data_build.generate.calendar.templates import (
