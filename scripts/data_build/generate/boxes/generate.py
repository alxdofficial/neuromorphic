...
from scripts.data_build.common.text import with_indef, indef_list, cap_first
from scripts.data_build.generate.boxes.state import (
    BoxesScenario, build_scenario, config_space_size,
)
from scripts.data_build.generate.boxes.templates import (
