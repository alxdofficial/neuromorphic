...
from scripts.data_build.common.text import cap_first

from scripts.data_build.generate.bio.state import (
    BiographicalScenario, build_scenario, config_space_size,
)
from scripts.data_build.generate.bio.templates.passages import (
    render_passage, PERSONAS,
)
from scripts.data_build.generate.bio.templates.questions_atomic import (
    generate_atomic_questions,
)
from scripts.data_build.generate.bio.templates.questions_relational import (
    generate_relational_questions,
)
from scripts.data_build.generate.bio.templates.questions_temporal import (
    generate_temporal_questions,
)
from scripts.data_build.generate.bio.templates.questions_aggregation import (
