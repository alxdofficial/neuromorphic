...
Per the composite schema in `scripts/data_build/common/schema.py`:
...
from scripts.data_build.generate.bio.world import World
from scripts.data_build.generate.bio.templates import render_passage
