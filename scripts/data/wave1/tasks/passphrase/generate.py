...
Usage:
    python -m scripts.data.wave1.tasks.passphrase.generate \\
...
from scripts.data.wave1.tasks.passphrase.state import (
    PassphraseScenario, build_scenario, config_space_size,
)
from scripts.data.wave1.tasks.passphrase.templates import (
