...
from scripts.data.wave1.tasks.biographical.builders.people import build_people
from scripts.data.wave1.tasks.biographical.builders.orgs import build_orgs
from scripts.data.wave1.tasks.biographical.builders.nations import build_nations
from scripts.data.wave1.tasks.biographical.builders.places import build_places
from scripts.data.wave1.tasks.biographical.builders.events import build_events
from scripts.data.wave1.tasks.biographical.builders.works import build_works
from scripts.data.wave1.tasks.biographical.builders.edges import populate_relationships
