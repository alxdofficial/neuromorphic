...
v4 pools live in:
    scripts/data/wave1_worldspec.py        (people, places, occupations, ...)
    scripts/data/wave1_worldspec_extra.py  (orgs, nations, events, works,
...
from scripts.data.wave1_worldspec import (
    FIRST_NAMES_F,
    LAST_NAMES,
...
from scripts.data.wave1_worldspec_extra import (
    FIRST_NAMES_M,
    ALL_FIRST_NAMES,
    ORG_NAME_PREFIXES,
    ORG_NAME_STEMS,
