...
from scripts.data.wave1.common.text import cap_first

from scripts.data.wave1.tasks.biographical.state import (
    BiographicalScenario, build_scenario, config_space_size,
)
from scripts.data.wave1.tasks.biographical.templates.passages import (
    render_passage, PERSONAS,
)
from scripts.data.wave1.tasks.biographical.templates.questions_atomic import (
    generate_atomic_questions,
)
from scripts.data.wave1.tasks.biographical.templates.questions_relational import (
    generate_relational_questions,
)
from scripts.data.wave1.tasks.biographical.templates.questions_temporal import (
    generate_temporal_questions,
)
from scripts.data.wave1.tasks.biographical.templates.questions_aggregation import (
