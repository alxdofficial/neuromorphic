...
from scripts.data_gen.common.text import count_word
from scripts.data_gen.tasks.revisions.state import (
    RevisionsScenario, build_scenario, config_space_size,
)
from scripts.data_gen.tasks.revisions.templates import (
