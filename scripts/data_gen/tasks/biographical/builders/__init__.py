...
from scripts.data_gen.tasks.biographical.builders.people import build_people
from scripts.data_gen.tasks.biographical.builders.orgs import build_orgs
from scripts.data_gen.tasks.biographical.builders.nations import build_nations
from scripts.data_gen.tasks.biographical.builders.places import build_places
from scripts.data_gen.tasks.biographical.builders.events import build_events
from scripts.data_gen.tasks.biographical.builders.works import build_works
from scripts.data_gen.tasks.biographical.builders.edges import populate_relationships
