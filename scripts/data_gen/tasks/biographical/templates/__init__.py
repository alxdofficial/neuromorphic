...
from scripts.data_gen.tasks.biographical.templates.passages import render_passage
from scripts.data_gen.tasks.biographical.templates.questions_atomic import generate_atomic_questions
from scripts.data_gen.tasks.biographical.templates.questions_relational import generate_relational_questions
from scripts.data_gen.tasks.biographical.templates.questions_temporal import generate_temporal_questions
from scripts.data_gen.tasks.biographical.templates.questions_aggregation import generate_aggregation_questions
