...
Usage:
    python -m scripts.data_gen.tasks.passphrase.generate \\
...
from scripts.data_gen.tasks.passphrase.state import (
    PassphraseScenario, build_scenario, config_space_size,
)
from scripts.data_gen.tasks.passphrase.templates import (
